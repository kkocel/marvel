...
public class RecyclerViewMatcher {
    ...
    private static class ItemViewMatcher extends TypeSafeMatcher<View> {

        static final int ITEM_VIEW_ID = -1;
        ...
        ItemViewMatcher(int recyclerViewId, int position, int targetViewId) {
            this.recyclerViewId = recyclerViewId;
